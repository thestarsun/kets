...
//			obj.remove();
		...
		this.fnClearTable = function( bRedraw )
		{
			...
			if ( typeof bRedraw == 'undefined' || bRedraw )
			{
                ...
                this.fnOpen = function( nTr, dataObj, sClass, tableId )
		{
...
//			nNewCell.colSpan = _fnVisbleColumns( oSettings );
                        nNewRow.className = nTr.getAttribute("class");
                        nNewRow.id = nTr.getAttribute("id");
...
//			else
//			{
				nNewRow.innerHTML = dataObj.html();
//			}
			...
			oSettings.aoOpenRows.push( {
				...
				"nParent": nTr
                        ...
                        //alert(nTr.getAttribute("id")+" "+dataObj.attr("id"))
			//dataObj.remove();
			return nNewRow;
		};
		 ...
		 */
		this.fnOpen1111 = function( nTr, dataObj, sClass, tableId )
		{
			/* Find settings from table node */
                        var elemIdMain = dataObj.attr('id');
                        var elemClassMain = dataObj.attr('class');
			var oSettings = _fnSettingsFromNode( this[_oExt.iApiIndex] );
...
//			this.fnClose( nTr );
			...
			var nNewRow = document.createElement("tr");
                        nNewRow.setAttribute('class', elemClassMain);
                        nNewRow.setAttribute('id', elemIdMain);
			var nNewCell = document.createElement("td");
//			nNewRow.appendChild( nNewCell );
//			nNewCell.className = sClass;
//			nNewCell.colSpan = _fnVisbleColumns( oSettings );
//                        nNewCell.innerHTML = mHtml;
                        nNewRow.innerHTML = dataObj.html();
//                        if(typeof(mHtml) == "array")
//                        {
//                            $.each(mHtml, function(index, value) { 
//                                
//                            });
//                        }
//console.log(mHtml);
...
//			}
			...
			/* If the nTr isn't on the page at the moment - then we don't insert at the moment */
//                        alert(elemIdMain);
//alert(dataObj.attr("id"));
                        dataObj.remove();
			var nTrs = $('tr', oSettings.nTBody);
                        if(nTr == 0)
                        {
                            $("#"+tableId+" tr").eq(0).before(nNewRow);
//                             $("#"+tableId).appendTo(nNewRow);

//                            $(nNewRow).insertAfter(tableId);
                        }
                        else{
//                            if ( $.inArray(nTr, nTrs) != -1 )
//                            {
...
//                            }
		...
		function _fnCalculateEnd( oSettings )
		{
			...
			else
			{
				...
				{
                                    console.log("oSettings._iDisplayStart - oSettings._iDisplayLength "+oSettings._iDisplayStart+" - "+oSettings._iDisplayLength)
					oSettings._iDisplayEnd = oSettings._iDisplayStart + oSettings._iDisplayLength;

				}
			}
//                        oSettings._iDisplayEnd = oSettings._iDisplayEnd + 1;
                        //console.log("oSettings._iDisplayEnd= "+oSettings._iDisplayEnd);
		}
